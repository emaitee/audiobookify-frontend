...
export default function ProfilePage() {
  ...
  return (
    <div className="max-w-4xl mx-auto md:p-4 bg-gray-50 min-h-screen">
      {/* Profile Header */}
      <div className="bg-white rounded-lg md:rounded-xl shadow-md overflow-hidden mb-4 md:mb-6">
            ...
            <div className="relative">
              {(profile.profilePicture || previewUrl) ? (
                <img 
                  ...
                  alt={profile.name} 
                  className="h-24 w-24 md:h-32 md:w-32 rounded-full object-cover border-2 border-indigo-100"
                />
              ) : (
                <div className="h-24 w-24 md:h-32 md:w-32 rounded-full bg-indigo-100 flex items-center justify-center">
                  <UserCircle2 size={48} className="text-indigo-500 md:hidden" />
                  <UserCircle2 size={64} className="text-indigo-500 hidden md:block" />
                </div>
              )}
              ...
              <>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start">
                  ...
                  <button 
                    ...
                    className="bg-indigo-100 hover:bg-indigo-200 text-indigo-700 font-medium py-1 px-3 md:py-2 md:px-4 rounded-full flex items-center text-sm"
                  >
                ...
                <div className="mt-4 flex">
                  <button 
                    ...
                    className="flex items-center text-red-600 hover:text-red-800 text-xs md:text-sm"
                  >
      ...
      {/* Content Section */}
      <div className="bg-white rounded-lg md:rounded-xl shadow-md overflow-hidden p-4 md:p-6">
        {activeTab === 'library' && (
              ...
              profile.library.map(id => {
                ...
                return (
                  <div key={id} className="flex flex-col">
                    <div className="relative h-40 sm:h-56 bg-gray-100 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                      <img 
                        src={book?.coverImage} 
                        alt={book?.title} 
                    ...
                    <h3 className="mt-2 text-xs sm:text-sm font-medium text-gray-900 truncate">{book?.title}</h3>
                    <p className="text-xs text-gray-500 truncate">{book?.author}</p>
                  </div>
                );
              })
            ) : (
              <div className="col-span-full text-center py-6 md:py-8 text-gray-500 text-sm">
          ...
          <div className="space-y-3 md:space-y-4">
            {profile.history.length > 0 ? (
              profile.history.map((item:ProfileHistoryBook, index) => {
                ...
                return (
                  <div key={index} className="border-b border-gray-200 pb-3 md:pb-4 last:border-0">
                    <div className="flex items-center">
                      <div className="h-12 w-8 sm:h-16 sm:w-12 flex-shrink-0 bg-gray-100 rounded overflow-hidden mr-3 md:mr-4">
                        <img 
                      ...
                      <div className="flex-grow">
                        ...
                        <div className="mt-1 relative pt-1">
                          <div className="overflow-hidden h-1 sm:h-2 text-xs flex rounded bg-gray-200">
                            <div 
